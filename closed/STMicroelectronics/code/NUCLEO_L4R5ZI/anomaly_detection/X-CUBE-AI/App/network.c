...
#define AI_TOOLS_DATE_TIME   "Mon Jun 10 15:01:25 2024"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    gemm_0_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 640);
    gemm_0_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 640);
    ...
    gemm_1_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 0);
    gemm_1_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    ...
    gemm_2_output_array.data = AI_PTR(g_network_activations_map[0] + 384);
    gemm_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 384);
    ...
    gemm_4_output_array.data = AI_PTR(g_network_activations_map[0] + 384);
    gemm_4_output_array.data_start = AI_PTR(g_network_activations_map[0] + 384);
    ...
    gemm_5_output_array.data = AI_PTR(g_network_activations_map[0] + 16);
    gemm_5_output_array.data_start = AI_PTR(g_network_activations_map[0] + 16);
    
    gemm_6_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 144);
    gemm_6_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 144);
    
    gemm_6_output_array.data = AI_PTR(g_network_activations_map[0] + 400);
    gemm_6_output_array.data_start = AI_PTR(g_network_activations_map[0] + 400);
    ...
    gemm_8_output_array.data = AI_PTR(g_network_activations_map[0] + 384);
    gemm_8_output_array.data_start = AI_PTR(g_network_activations_map[0] + 384);
    ...
    gemm_9_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    gemm_9_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
