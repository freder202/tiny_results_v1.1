...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 56672, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (56672)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (56672)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 78744, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (78744)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (78744)
