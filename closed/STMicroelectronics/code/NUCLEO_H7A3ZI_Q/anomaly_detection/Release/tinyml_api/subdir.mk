...
tinyml_api/%.o tinyml_api/%.su tinyml_api/%.cyclo: ../tinyml_api/%.c tinyml_api/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m7 -std=gnu11 -DUSE_HAL_DRIVER -DSTM32H7A3xxQ -DEE_CFG_ENERGY_MODE=0 -c -I../Core/Inc -I"/home/fred/Desktop/tiny_results_v1.1/closed/STMicroelectronics/code/NUCLEO_H7A3ZI_Q/anomaly_detection/tinyml_api" -I../Middlewares/ST/AI/Inc -I../X-CUBE-AI/App -I../Drivers/STM32H7xx_HAL_Driver/Inc -I../Drivers/STM32H7xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32H7xx/Include -I../Drivers/CMSIS/Include -Os -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv5-d16 -mfloat-abi=hard -mthumb -o "$@"
