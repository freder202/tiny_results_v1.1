...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 22528, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (22528)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (22528)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 43180, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (43180)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (43180)
