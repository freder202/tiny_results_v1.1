...
#define AI_NETWORK_MODEL_SIGNATURE     "198e3cb3a9be5056a47a775484aec3ff"
...
#define AI_TOOLS_DATE_TIME   "Tue Jul  9 10:51:30 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 1, 3, 3, 10), AI_STRIDE_INIT(4, 4, 4, 40, 120),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  6, 0x0,
  AI_SHAPE_INIT(4, 10, 3, 3, 20), AI_STRIDE_INIT(4, 4, 40, 800, 2400),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  8, 0x0,
  AI_SHAPE_INIT(4, 20, 3, 3, 40), AI_STRIDE_INIT(4, 4, 80, 3200, 9600),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 320, 5, 1, 1), AI_STRIDE_INIT(4, 4, 1280, 6400, 6400),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  12, 0x0,
  AI_SHAPE_INIT(4, 5, 5, 1, 1), AI_STRIDE_INIT(4, 4, 20, 100, 100),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  15, 0x0,
  AI_SHAPE_INIT(4, 1, 10, 32, 16), AI_STRIDE_INIT(4, 4, 4, 40, 1280),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  17, 0x0,
  AI_SHAPE_INIT(4, 1, 10, 16, 8), AI_STRIDE_INIT(4, 4, 4, 40, 640),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  18, 0x0,
  AI_SHAPE_INIT(4, 1, 20, 16, 8), AI_STRIDE_INIT(4, 4, 4, 80, 1280),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  20, 0x0,
  AI_SHAPE_INIT(4, 1, 20, 8, 4), AI_STRIDE_INIT(4, 4, 4, 80, 640),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  21, 0x0,
  AI_SHAPE_INIT(4, 1, 40, 8, 4), AI_STRIDE_INIT(4, 4, 4, 160, 1280),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  23, 0x0,
  AI_SHAPE_INIT(4, 1, 40, 4, 2), AI_STRIDE_INIT(4, 4, 4, 160, 640),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 43180, 1, 1),
    43180, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 22528, 1, 1),
    22528, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_conv2d_3_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_9_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_conv2d_3_input0_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    serving_default_conv2d_3_input0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    ...
    gemm_7_output_array.data = AI_PTR(g_network_activations_map[0] + 1280);
    gemm_7_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1280);
    ...
    gemm_8_output_array.data = AI_PTR(g_network_activations_map[0] + 20);
    gemm_8_output_array.data_start = AI_PTR(g_network_activations_map[0] + 20);
    ...
    conv2d_0_output_array.data = AI_PTR(g_network_activations_map[0] + 2048);
    conv2d_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2048);
    
    nl_0_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 2048);
    nl_0_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2048);
    
    pool_1_output_array.data = AI_PTR(g_network_activations_map[0] + 2048);
    pool_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2048);
    
    conv2d_2_output_array.data = AI_PTR(g_network_activations_map[0] + 7168);
    conv2d_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 7168);
    
    nl_2_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 7168);
    nl_2_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 7168);
    
    pool_3_output_array.data = AI_PTR(g_network_activations_map[0] + 2048);
    pool_3_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2048);
    
    conv2d_4_output_array.data = AI_PTR(g_network_activations_map[0] + 4608);
    conv2d_4_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4608);
    
    nl_4_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 9728);
    nl_4_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 9728);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 360);
    conv2d_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 360);
    
    conv2d_2_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 400);
    conv2d_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 400);
    
    conv2d_2_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 7600);
    conv2d_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 7600);
    
    conv2d_4_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_weights_array.data = AI_PTR(g_network_weights_map[0] + 7680);
    conv2d_4_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 7680);
    
    conv2d_4_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 36480);
    conv2d_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 36480);
    
    gemm_7_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_7_weights_array.data = AI_PTR(g_network_weights_map[0] + 36640);
    gemm_7_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 36640);
    
    gemm_7_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_7_bias_array.data = AI_PTR(g_network_weights_map[0] + 43040);
    gemm_7_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 43040);
    
    gemm_8_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_8_weights_array.data = AI_PTR(g_network_weights_map[0] + 43060);
    gemm_8_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 43060);
    
    gemm_8_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_8_bias_array.data = AI_PTR(g_network_weights_map[0] + 43160);
    gemm_8_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 43160);
