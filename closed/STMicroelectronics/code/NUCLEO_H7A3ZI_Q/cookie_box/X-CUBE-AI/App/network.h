...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "model_pulse_5bits_h5"
...
#define AI_NETWORK_IN_1_HEIGHT      (16)
#define AI_NETWORK_IN_1_WIDTH       (32)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (16 * 32 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  (2048)
